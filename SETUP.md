...
4. No `index.html`, preencha as duas constantes no topo do `<script>`. A anon key é pública por design (todo visitante do site a recebe no navegador); a segurança vem das políticas RLS acima.
